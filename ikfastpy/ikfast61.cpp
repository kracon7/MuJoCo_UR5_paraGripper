...
///
/// ikfast version 0x10000049 generated on 2019-07-06 16:23:15.832192
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x36=((((-1.0)*x30))+((x0*x24)));
x37=((((-1.0)*x31))+((x10*x24)));
x38=(x21*(((((-1.0)*x27))+(((-1.0)*x28)))));
x39=(x17*(((((-1.0)*x27))+(((-1.0)*x28)))));
x40=(x37*x5);
x41=(x36*x5);
x42=(((x33*x5))+((x6*(((((-1.0)*x27))+(((-1.0)*x28)))))));
x43=(x41+((x38*x6)));
x44=(x40+((x39*x6)));
x45=(((x38*x5))+((x6*(((((-1.0)*x21*x24))+x30)))));
x46=(((x39*x5))+((x6*(((((-1.0)*x17*x24))+x31)))));
x47=(x43*x9);
eerot[0]=(((x7*((x47+((x10*x11))))))+((x45*x8)));
eerot[1]=(((x45*x7))+((x8*(((((-1.0)*x11*x17))+(((-1.0)*x22*x43)))))));
eerot[2]=(x26+((x11*(((((-1.0)*x16*x38))+(((-1.0)*x23*x36)))))));
eetrans[0]=((((0.10915)*x10))+(((-1.0)*x13*x24))+(((-1.0)*x0*x20))+((x11*(((((-1.0)*x12*x38))+(((-1.0)*x15*x36))))))+((x6*((((x14*x24))+(((-1.0)*x14*x29))))))+(((0.3)*x26))+((x13*x29))+((x5*((((x14*x28))+((x14*x27)))))));
eerot[3]=(((x46*x8))+((x7*(((((-1.0)*x0*x11))+((x44*x9)))))));
eerot[4]=(((x46*x7))+((x8*(((((-1.0)*x22*x44))+((x11*x21)))))));
eerot[5]=((((-1.0)*x21*x9))+((x11*(((((-1.0)*x16*x39))+(((-1.0)*x23*x37)))))));
eetrans[1]=((((-0.39225)*x10*x24))+(((-0.3)*x25))+(((-0.10915)*x0))+(((-1.0)*x10*x20))+((x11*(((((-1.0)*x12*x39))+(((-1.0)*x15*x37))))))+((x6*((((x18*x24))+(((-1.0)*x18*x29))))))+((x5*((((x18*x28))+((x18*x27))))))+((x10*x19*x3)));
eerot[6]=(((x7*x9*((x35+x34))))+((x42*x8)));
eerot[7]=(((x42*x7))+((x8*x9*(((((-1.0)*x35))+(((-1.0)*x34)))))));
eerot[8]=(x11*(((((-1.0)*x16*x33))+(((-1.0)*x23*x32)))));
eetrans[2]=((0.089159)+((x11*(((((-1.0)*x12*x33))+(((-1.0)*x15*x32))))))+(((-1.0)*x1*x19))+((x5*(((((-0.09465)*x24))+(((0.09465)*x29))))))+(((-0.425)*x3))+((x6*(((((0.09465)*x28))+(((0.09465)*x27))))))+(((-0.39225)*x28)));
}
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - ur5 (cca4a407ad9dfb31474658ea741aaaad)>"; }
